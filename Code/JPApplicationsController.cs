...
namespace JobPlacementDashboard.Controllers
{
    public class JPApplicationsController : Controller
    {
        ...
        public ViewResult Index(string sortOrder, string searchString)
        {
            ...
            ViewBag.InterviewSortParm = sortOrder == "Interview" ? "interview_desc" : "Interview";
            ViewBag.HeardBackSortParm = sortOrder == "HeardBack" ? "heardback_desc" : "HeardBack";
            ...
            if (!String.IsNullOrEmpty(searchString))
            {
                ...
                foreach (string sString in searchStrings)
                {
                    applications = applications.Where(s => s.ApplicationUser.FirstName.Contains(sString) || s.ApplicationUser.LastName.Contains(sString)
                    || s.JPCompanyName.Contains(sString) || s.JPJobTitle.ToString().Contains(sString) || s.JPJobCategory.ToString().Contains(sString)
                    || s.JPCompanyCity.Contains(sString));
                }
            }
            ...
            switch (sortOrder)
            {
                ...
                case "companyState_desc":
                    ...
                    break;
                case "Interview":
                    applications = applications.OrderBy(s => s.Interview);
                    break;
                case "interview_desc":
                    applications = applications.OrderByDescending(s => s.Interview);
                    break;
                ...
                case "applicationDate_desc":
                    ...
                    break;
                case "HeardBack":
                    applications = applications.OrderBy(s => s.HeardBack);
                    break;
                case "heardback_desc":
                    applications = applications.OrderByDescending(s => s.HeardBack);
                    break;
        ...
        public ActionResult StudentIndex(string sortOrder, string searchString)
        {
            ...
            ViewBag.InterviewSort = sortOrder == "Interview" ? "interview_desc" : "Interview";
            ViewBag.HeardBackSort = sortOrder == "HeardBack" ? "heardback_desc" : "HeardBack";
